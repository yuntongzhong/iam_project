...
public class ApiMapper {
    ...
    public AppClientResponse toAppClientResponse(AppClient appClient) {
        return new AppClientResponse(
                ...
                positiveOrDefault(appClient.getAuthorizationCodeTtlMinutes(), 5),
                positiveOrDefault(appClient.getAccessTokenTtlMinutes(), 30),
                positiveOrDefault(appClient.getRefreshTokenTtlMinutes(), 480),
                appClient.getReuseRefreshTokens() != null && appClient.getReuseRefreshTokens(),
                appClient.getActive()
        );
    }
    ...
    private Integer positiveOrDefault(Integer value, int fallback) {
